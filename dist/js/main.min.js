...
new _test.default('Testing');

},{"./modules/test.js":2,"./vendor/modernizr.js":3}],2:[function(require,module,exports){
"use strict";
...
function () {
  ...
  _createClass(TestModule, [{
    ...
    value: function printName() {
      console.log("Init ".concat(this.name, " module!"));
    }
  }]);
...
!function (e, t, n) {
  ...
  function d() {
    var e = t.body;
    return e || (e = i(k ? "svg" : "body"), e.fake = !0), e;
  }
  ...
  function v(e, t, a, o) {
    ...
    for (p = e.length, f = 0; p > f; f++) {
      if (m = e[f], g = H.style[m], l(m, "-") && (m = c(m)), H.style[m] !== n) {
        ...
        if (H.style[m] != g) return s(), "pfx" == t ? m : !0;
      }
    }
  ...
  k || !function (e, t) {
    ...
    e.html5 = b, l(t), "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = b);
  }("undefined" != typeof e ? e : this, t), Modernizr.addTest("geolocation", "geolocation" in navigator), Modernizr.addTest("history", function () {
  ...
  Modernizr.inputtypes = function (e) {
    for (var r, a, o, i = e.length, s = "1)", c = 0; i > c; c++) {
      $.setAttribute("type", r = e[c]), o = "text" !== $.type && "style" in $, o && ($.value = s, $.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && $.style.WebkitAppearance !== n ? (E.appendChild($), a = t.defaultView, o = a.getComputedStyle && "textfield" !== a.getComputedStyle($, null).WebkitAppearance && 0 !== $.offsetHeight, E.removeChild($)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? $.checkValidity && $.checkValidity() === !1 : $.value != s)), j[e[c]] = !!o;
    }
